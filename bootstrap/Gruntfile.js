...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    less: {
      ...
      compileTheme: {
        options: {
          ...
          sourceMapFilename: '../app/css/<%= pkg.name %>-theme.css.map'
        },
        src: 'less/theme.less',
        dest: '../app/css/<%= pkg.name %>-theme.css'
      }
    },
    ...
    autoprefixer: {
      ...
      theme: {
        ...
        src: '../app/css/<%= pkg.name %>-theme.css'
      },
      docs: {
    ...
    cssmin: {
      ...
      minifyTheme: {
        src: '../app/css/<%= pkg.name %>-theme.css',
        dest: '../app/css/<%= pkg.name %>-theme.min.css'
      },
      docs: {
        src: [
  ...
  grunt.registerTask('commonjs', 'Generate CommonJS entrypoint module in dist dir.', function () {
    ...
    var destFilepath = '../app/js/npm.js';
